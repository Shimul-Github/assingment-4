...
function checkName(str) {
    ...
    const covertedCase =[];
    for(let index = 0; index<preferredLetters.length; index++){
        // console.log(preferredLetters[index]);
        covertedCase.push(preferredLetters[index].toLowerCase());
        // console.log(sorted);
    }
    ...
    for(let i = 0; i<preferredLetters.length; i++){
        // covertedCase.push(preferredLetters[i].toLocaleLowerCase());
        // console.log(covertedCase);

        // console.log(letter);
        if( covertedCase.includes(lastLetterOfName))
        {
                // preferredLetters.includes(lastLetterOfName)
